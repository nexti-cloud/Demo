...
{
    public class ExerciseRewrite : IExercise
    {
        ...
        public List<ItemRewrite> ItemList { get; set; }
        ...
        public ExerciseRewrite(DataTable sheet, Section section, bool includeLocked)
        {
            ...
            for (int i = 2; i < sheet.Rows.Count; i++)
            {
                ...
                ItemRewrite item = new ItemRewrite();
