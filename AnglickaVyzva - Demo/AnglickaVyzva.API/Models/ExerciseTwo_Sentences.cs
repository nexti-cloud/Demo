...
{
    public class ExerciseTwo_Sentences : IExercise
    {
        ...
        public string Type { get; set; } = "two_sentences";
        public bool IsLock { get; set; }
        public bool IsDone { get; set; }

        public string Title { get; set; }
        public string Subtitle { get; set; }
        public List<ItemTwo_Sentences> ItemList { get; set; }

        public class ItemTwo_Sentences
        {
        ...
        public ExerciseTwo_Sentences(DataTable sheet, Section section, bool includeLocked)
        {
            ...
            ItemList = new List<ItemTwo_Sentences>();
            ...
            for (int i = 2; i < sheet.Rows.Count; i++)
            {
                ...
                ItemTwo_Sentences item = new ItemTwo_Sentences();
